...
export default function KPICardPremium({
  ...
  return (
    <div
      className={`premium-card ${active ? "active" : ""} p-5 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5"}`}
    ...
    >
      ...
      <div className="flex items-baseline gap-1.5 mb-1.5">
        <span
          ...
          style={{ color: active ? color : "#1e293b", transition: "color 0.3s ease" }}
        >
